...
<script type="text/javascript">
	...
	function showTran(){
		$.ajax({
			url:"customer/getTranByCustomerId",
			data:{
				"id":"${cu.id}"
			},
			type:"get",
	...
	function showContacts(){
		$.ajax({
			url:"customer/getContactsByCustomerId",
			data:{
				"id":"${cu.id}"
			},
			type:"get",
			...
			success:function (data) {
				var html = "";
				if(JSON.stringify(data) == "[]"){
					html += '<tr class="active"><td colspan="4" style="text-align: center">没有与该客户关联的联系人信息</td></tr>';
				}else{
					$.each(data,function (i,n) {
						html += '<tr>';
						...
						html += '<td>'+n.email+'</td>';
						html += '<td>'+n.mphone+'</td>';
						html += '<td><a href="javascript:void(0);" onclick="unbundContacts(\''+n.id+'\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>删除</a></td>';
						html += '</tr>';
					});
				}
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${cu.name} <small><a href="http://${cu.website}" target="_blank">${cu.website}</a></small></h3>
		</div>
...
<%--			<button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-minus"></span> 删除</button>--%>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${cu.owner}</b></div>
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">名称</div>
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${cu.name}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			<div style="width: 300px; color: gray;">公司网站</div>
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${cu.website}</b></div>
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">公司座机</div>
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${cu.phone}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			<div style="width: 300px; color: gray;">创建者</div>
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${cu.createBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${cu.createTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			<div style="width: 300px; color: gray;">修改者</div>
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${cu.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${cu.editTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
        ...
        <div style="position: relative; left: 40px; height: 30px; top: 50px;">
            ...
            <div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${cu.nextContactTime}</b></div>
