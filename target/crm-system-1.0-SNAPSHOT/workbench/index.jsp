	...
	$(function(){
		...
		$("#updatePwd").click(function () {
            ...
            if(oldPwd==""){
                ...
                $("#msg").html("*原密码输入有误，请重新输入");
                $("#oldPwd").focus();
                return false;
            }else if(newPwd!=confirmPwd){
                $("#msg").html("*新密码与确认密码输入不一致，请重新输入");
                $("#confirmPwd").focus();
                return false;
            }
			//去后台验证修改操作
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<span style="margin-left: 200px;color: red;" id="msg"></span>
					</form>
				</div>
				<div class="modal-footer">
...
<%--				<li class="liClass"><a href="workbench/visit/index.html" target="workareaFrame"><span class="glyphicon glyphicon-phone-alt"></span> 售后回访</a></li>--%>
				<li class="liClass">
					...
					<ul id="no2" class="nav nav-pills nav-stacked collapse">
                        ...
                        <li class="liClass"><a href="workbench/chart/transaction/tranHistory.jsp" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 交易历史统计图表</a></li>
					</ul>
				</li>
